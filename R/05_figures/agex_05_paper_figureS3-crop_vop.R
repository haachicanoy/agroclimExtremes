...
# Figure S3: crop VOP vs drought intensification
# By: Harold Achicanoy
# WUR & ABC
...
ggplot2::ggsave(filename = paste0(root,'/agex_results/agex_figures/FigureS3-agex-crop_vop.png'), plot = fig3, device = 'png', width = 10, height = 12.5, units = 'in', dpi = 350)
rm(ggm,
