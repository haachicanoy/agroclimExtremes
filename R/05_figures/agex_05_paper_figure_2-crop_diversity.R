...
# Figure 2: crop diversity vs drought intensification
# By: Harold Achicanoy
# WUR & ABC
...
ggplot2::ggsave(filename = paste0(root,'/agex_results/agex_figures/Figure2-agex-crop_diversity.png'), plot = fig3, device = 'png', width = 10, height = 12.5, units = 'in', dpi = 350)
rm(ggm,
