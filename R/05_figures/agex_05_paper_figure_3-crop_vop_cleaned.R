...
ggplot2::ggsave(filename = paste0(root,'/agex_results/agex_figures/Figure3_paper1-crop_vop_cleaned.png'), plot = fig3, device = 'png', width = 10, height = 12.5, units = 'in', dpi = 350)
rm(ggm,
