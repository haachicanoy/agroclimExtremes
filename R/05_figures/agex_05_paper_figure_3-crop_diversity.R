...
### Panel c) Africa ----
# Cluster: 270 (Ivory Coast, Mali, Guinea)
# One growing season
...
ggplot2::ggsave(filename = paste0(root,'/agex_results/agex_figures/Figure3_paper1-crop_diversity.png'), plot = fig3, device = 'png', width = 12, height = 10, units = 'in', dpi = 350)
rm(ggm,
