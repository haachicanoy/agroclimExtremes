...
idx_ts <- terra::rast(paste0(root,'/agex_indices/agex_spei-6/agex_spei-6_25km/two_s2_spei-6_25km.tif'))
# Filter time series per cluster of interest
...
ggplot2::ggsave(filename = paste0(root,'/agex_results/agex_figures/Figure3_paper1-crop_vop.png'), plot = fig3, device = 'png', width = 12, height = 10, units = 'in', dpi = 350)
rm(ggm,
